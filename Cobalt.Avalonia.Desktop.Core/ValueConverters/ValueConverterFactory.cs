namespace Cobalt.Avalonia.Desktop.Core.ValueConverters;
...
public static class ValueConverterFactory
{
    ...
    public static IValueConverter<string?> CreateDefaultStringValueConverter()
    ...
    public static IValueConverter<double?> CreateDefaultDoubleValueConverter()
    ...
    public static IValueConverter<float?> CreateDefaultFloatValueConverter()
    ...
    public static IValueConverter<decimal?> CreateDefaultDecimalValueConverter()
    ...
    public static IValueConverter<int?> CreateDefaultIntValueConverter()
    ...
    public static IValueConverter<uint?> CreateDefaultUIntValueConverter()
        => new ValueConverter<uint?>(
    ...
    public static IValueConverter<short?> CreateDefaultShortValueConverter()
    ...
    public static IValueConverter<ushort?> CreateDefaultUShortValueConverter()
        => new ValueConverter<ushort?>(
    ...
    public static IValueConverter<long?> CreateDefaultLongValueConverter()
    ...
    public static IValueConverter<ulong?> CreateDefaultULongValueConverter()
        => new ValueConverter<ulong?>(
    ...
    public static IValueConverter<byte[]?> CreateDefaultHexadecimalValueConverter()
    ...
    public static IValueConverter<byte[]?> CreateDefaultBase64ValueConverter()
        => new Base64ValueConverter();
}